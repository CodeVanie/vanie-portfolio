...
export default function ProjectFolioTile() {
    ...
    return (
        <a href="/" className={`project-tiles bg-black/80 bg-blend-multiply bg-smooth-purple bg-cover bg-center font-zendots shadow-[2px_0_8px_#FFB3E3,-2px_0_8px_#FFB3E3] ${pathname === "/home" ? "max-w-[281px]" : ""}`}>
