...
export default function ProjectTodoTile() {
    ...
    return (
        <a href="https://vanie-todo-to-do.vercel.app/" target="_blank" rel="noopener noreferrer" className={`project-tiles bg-black/50 bg-blend-multiply bg-todotodo bg-cover font-quicks shadow-[2px_0_8px_#e7b574,-2px_0_8px_#e7b574] ${pathname === "/home" ? "max-w-[275px]" : ""}`}>
