...
export default function ProjectTodoTile({ onClick }) {
    const { pathname } = useLocation();
    
    return (
        <div onClick={onClick} className={`project-tiles bg-black/50 bg-blend-multiply bg-todotodo bg-cover font-quicks shadow-[2px_0_8px_#e7b574,-2px_0_8px_#e7b574] ${pathname === "/home" ? "max-w-[275px]" : ""}`}>
